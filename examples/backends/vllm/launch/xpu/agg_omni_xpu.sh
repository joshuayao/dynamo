...
# Stage config path - use XPU-specific single-stage LLM config for text-to-text
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
source "$SCRIPT_DIR/../../../../common/launch_utils.sh"
STAGE_CONFIG="${STAGE_CONFIG:-$SCRIPT_DIR/../stage_configs/single_stage_llm_xpu.yaml}"
